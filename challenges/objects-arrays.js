...
console.log("a tyrannosaurus goes: ", tyrannosaurus.roar());
...
console.log("alphabetized list of universities: ", universities);
...
console.log("first names and emails: ", contactInfo);
...
scientific_name of each animal. displayNames will be an array of strings, and each string should follow this pattern: "Name: Jackal, asiatic, Scientific: Canis 
aureus."
